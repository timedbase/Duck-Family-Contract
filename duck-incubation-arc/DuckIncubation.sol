...
contract DuckIncubationArc is Initializable, UUPSUpgradeable, Ownable2StepUpgradeable, LaunchRouting {
        ...
        returns (uint256 tokensOut, uint256 feeQuote)
    {
        ...
        return DuckIncubationBuying.previewBuy(
            tc.migrationTarget, tc.raisedQuote, tc.virtualQuote, tc.bcTokensTotal, tc.bcTokensSold, tc.k, quoteIn
        );
    }
        ...
        returns (uint256 quoteOut, uint256 feeQuote)
    {
        ...
        return DuckIncubationBuying.previewSell(
            tc.raisedQuote, tc.virtualQuote, tc.bcTokensTotal, tc.bcTokensSold, tc.k, tokensIn
        );
    }

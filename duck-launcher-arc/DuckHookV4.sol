...
contract DuckHookV4Arc {
    ...
    uint256 public ctoFee = 50e18; // 50 USDC -- Arc's native gas token, 18 decimals
    ...
    // separate 1% pool-tier LP fee instead (see DuckLockerArc).
